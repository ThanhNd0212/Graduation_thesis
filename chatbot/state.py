"""Slot-filling conversation state (§5 of chatbot_demo_plan.md).
...
AFTER confirmation (§3). Every change is logged to `history` ("lưu lại & cập nhật từng label").
"""
...
class SessionState:
    def __init__(self, session_id: str):
        ...
        self.last_product_id = None              # most-recently confirmed/proposed product (§2.2)
    ...
    def update_entities(self, entities: dict):
        """Apply this turn's NER entities. PRODUCT_NAME is skipped (goes via confirm §3)."""
    ...
    def _fix_budget_order(self):
        """§2.1: if MIN_BUDGET > MAX_BUDGET, swap them."""
